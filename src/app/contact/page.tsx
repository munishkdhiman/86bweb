...
const services = [
  "AI-First Business Strategy", "Digital Human Agents", "AI Travel & Route Planning",
  "Revenue Tracking & Auditing", "Data Organization & Investor Readiness",
  "AI German Language Training", "AI App Testing & QA", "LLM Orchestration & RAG",
...
const nextSteps = [
  { icon: Lock, title: "NDA Signed", desc: "We send an NDA within 24 hours — signed before any technical discussion begins." },
  { icon: MessageSquare, title: "Discovery Call", desc: "A 30-minute call with our solution engineers to map your use case and constraints." },
  { icon: FileSearch, title: "Technical Proposal", desc: "We deliver a detailed proposal covering architecture, timeline, and pricing within 5 business days." },
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-12">
          <div className="max-w-2xl">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-50 border border-blue-200/60 text-blue-700 text-xs font-semibold tracking-wide mb-6">
              ...
              NDA Protected · No Commitment Required
            </div>
          ...
          <div className="lg:col-span-3">
            {submitted ? (
              <div className="bg-white rounded-3xl border border-slate-200/60 p-12 text-center">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-100 flex items-center justify-center mx-auto mb-6">
                ...
                <p className="text-base text-slate-500 font-light leading-relaxed max-w-sm mx-auto">
                  We&apos;ll review your request and send an NDA within 24 business hours. Check your inbox.
                </p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="bg-white rounded-3xl border border-slate-200/60 overflow-hidden">
                ...
                <div className="p-8 space-y-5">
                    ...
                    {[{ name: "firstName", label: "First Name" }, { name: "lastName", label: "Last Name" }].map((f) => (
                      <div key={f.name}>
                        ...
                        <input
                          ...
                          placeholder={f.label}
                          className="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 text-sm text-slate-900 placeholder-slate-400 focus:outline-none focus:border-blue-400 focus:bg-white transition-all"
                        />
                      </div>
                    ))}
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      value={form.service}
                      onChange={handleChange}
                      className="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 text-sm text-slate-900 focus:outline-none focus:border-blue-400 focus:bg-white transition-all"
                    >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      value={form.message}
                      onChange={handleChange}
                      placeholder="Tell us about the workflow, data, or problem you want AI to solve..."
                      className="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 text-sm text-slate-900 placeholder-slate-400 focus:outline-none focus:border-blue-400 focus:bg-white transition-all resize-none"
                    />
                  </div>
                </div>
                ...
                <div className="px-8 pb-8">
                  <button
                    type="submit"
                    className="w-full py-4 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-sm font-bold shadow-lg shadow-blue-500/25 hover:opacity-90 transition-all"
                  >
                    Send Enquiry — NDA Will Be Sent Within 24h
                  </button>
                  <p className="text-center text-xs text-slate-400 font-light mt-4">
                    <Lock className="inline w-3 h-3 mr-1" />
                    Your information is never shared. All data is treated under NDA.
                  </p>
                </div>
              </form>
            )}
