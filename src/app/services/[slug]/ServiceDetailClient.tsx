      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <div>
              <h2 className="text-2xl font-bold text-zinc-900 mb-6">Implementation Pipeline</h2>
            ...
            <div>
              <h2 className="text-2xl font-bold text-zinc-900 mb-6">Use Cases</h2>
          ...
          <div className="space-y-6">
            <div className="bg-zinc-900 rounded-2xl p-6 text-white sticky top-24">
