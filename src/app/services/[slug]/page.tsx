...
import { ArrowRight, CheckCircle2, Cpu, Network, Bot, Globe, BarChart3, Briefcase, BookOpen, FlaskConical, Workflow } from "lucide-react";
...
const iconMap: Record<string, React.ElementType> = {
  Network, Bot, Globe, BarChart3, Briefcase, BookOpen, FlaskConical, Workflow, Cpu,
};
...
export default function ServiceDetailPage({ params }: PageProps) {
  ...
  // Related services (other services, max 3)
    ...
    <div className="min-h-screen bg-[#f8fafc] font-sans">
      ...
      <section className="relative pt-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 pt-20 pb-32">
          {/* Breadcrumb */}
          <div className="flex items-center gap-2 text-xs font-medium text-white/50 mb-8">
          ...
          <div className="max-w-2xl">
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                href="/contact"
                className="inline-flex items-center gap-2 px-7 py-3.5 rounded-xl bg-white text-blue-700 text-sm font-bold shadow-lg hover:bg-blue-50 transition-all group"
              >
                {svc.ctaLabel}
              ...
              <Link
                href="/services"
                className="inline-flex items-center gap-2 px-7 py-3.5 rounded-xl border border-white/25 text-white text-sm font-semibold hover:bg-white/10 transition-all"
              >
                ← All Services
              </Link>
            </div>
      ...
      <section className="relative z-10 -mt-1 bg-white border-y border-slate-200/60">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 py-10 grid grid-cols-1 md:grid-cols-3 gap-0 divide-y md:divide-y-0 md:divide-x divide-slate-100">
          {svc.metrics.map((m) => (
            <div key={m.label} className="text-center py-6 md:py-0 md:px-10">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-light text-slate-900 tracking-tight mb-6 leading-snug">
              ...
              <span className="font-semibold text-slate-900">without this</span>
            </h2>
          ...
          <div className="bg-slate-50 rounded-2xl border border-slate-200/60 p-8 space-y-4">
            <h3 className="text-sm font-semibold text-slate-700 uppercase tracking-widest mb-6">Common Pain Points</h3>
            {["Manual processes consuming 40%+ of team capacity", "Data locked in siloed, unstructured legacy systems", "No clear path from AI pilot to production deployment", "Compliance and security concerns blocking adoption"].map((pain) => (
      ...
      <section className="py-24 bg-white border-y border-slate-200/40">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-50 border border-blue-200/60 text-blue-700 text-xs font-semibold tracking-wide mb-5">
              Process
            </div>
            ...
            {svc.steps.map((step, i) => (
              <div key={step.title} className="relative">
                {i < svc.steps.length - 1 && (
                  <div className="hidden lg:block absolute top-8 left-[calc(100%-12px)] w-6 h-px bg-blue-200 z-10" />
                )}
                <div className="bg-white rounded-2xl border border-slate-200/60 p-6 hover:border-blue-200 hover:shadow-lg hover:shadow-blue-500/8 transition-all">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <p className="text-base text-slate-500 font-light leading-relaxed mb-10">
                Every {svc.title} engagement includes these core capabilities, customized to your specific industry and infrastructure.
              </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {svc.features.map((feat) => (
                <div key={feat.title} className="bg-white rounded-xl border border-slate-200/60 p-5 hover:border-blue-200 hover:shadow-md hover:shadow-blue-500/8 transition-all">
      ...
      {/* ── TECH STACK ────────────────────────────────────────────────────── */}
      <section className="py-16 bg-white border-y border-slate-200/40">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="flex flex-col md:flex-row md:items-center gap-8">
            <div className="flex-shrink-0">
              <div className="text-xs font-semibold text-slate-400 uppercase tracking-widest mb-1">Technology Stack</div>
              <div className="text-sm font-semibold text-slate-700">Tools we deploy for this service</div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="flex items-center justify-between mb-10">
            <h2 className="text-2xl font-light text-slate-900">
              Related <span className="font-semibold">Services</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {related.map((rel) => {
              ...
              return (
                <Link key={rel.slug} href={`/services/${rel.slug}`} className="group bg-white rounded-2xl border border-slate-200/60 overflow-hidden hover:border-blue-200 hover:shadow-lg hover:shadow-blue-500/8 transition-all">
