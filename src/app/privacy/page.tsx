      ...
      <section className="py-16">
        <div className="max-w-3xl mx-auto px-6 space-y-8">
          {[
            ...
            { h: '4. Client Data', p: 'All client project data is handled under the terms of a strict confidentiality agreement signed prior to any technical engagement. Client data is never used to train models or shared with other clients.' },
            { h: '5. Data Retention', p: 'Contact form data is retained for a maximum of 12 months. Client engagement data is retained in accordance with the terms agreed in the relevant contract and confidentiality agreement.' },
